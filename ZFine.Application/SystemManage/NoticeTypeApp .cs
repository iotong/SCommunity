...
{
    public class NoticeTypeApp
    {
        private INoticeTypeRepository service = new NoticeTypeRepository();


        public List<NoticeTypeEntity> GetList()
        {
            return service.IQueryable().ToList();
        }
        public NoticeTypeEntity GetForm(string keyValue)
        {
        ...
        public void SubmitForm(NoticeTypeEntity areaEntity, string keyValue)
        {
